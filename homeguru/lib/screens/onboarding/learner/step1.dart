...
class LearnerStep1Body extends StatefulWidget {
  ...
  @override
  State<LearnerStep1Body> createState() => _LearnerStep1BodyState();
}

class _LearnerStep1BodyState extends State<LearnerStep1Body> {
          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  _Card(cs: cs, child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _CardTitle(label: 'Personal info', cs: cs, tt: tt),
                  ...
                  _Card(cs: cs, child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _CardTitle(label: 'Contact', cs: cs, tt: tt),
                      const SizedBox(height: 16),
                      TextFormField(
                      ...
                      PhoneField(
                        ...
                        sending: _sendingOtp,
                        onSendOtp: _sendOtp,
                        useTertiary: widget.useTertiary,
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: _verifyingOtp
                                ? Padding(padding: const EdgeInsets.only(right: 14), child: SizedBox(width: 18, height: 18, child: CircularProgressIndicator(strokeWidth: 2, color: brandColor)))
                                : TextButton(
                                    ...
                                    child: Text('Verify', style: tt.labelMedium?.copyWith(color: brandColor, fontWeight: FontWeight.w700)),
                                  ),
                  ...
                  _Card(cs: cs, child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _CardTitle(label: 'Referral', cs: cs, tt: tt),
                  ...
                  _Card(cs: cs, child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      _CardTitle(label: 'Security', cs: cs, tt: tt),
                      const SizedBox(height: 16),
                      TextFormField(
...
class _CardTitle extends StatelessWidget {
  const _CardTitle({required this.label, required this.cs, required this.tt});
  final String label;
  final ColorScheme cs;
  final TextTheme tt;
