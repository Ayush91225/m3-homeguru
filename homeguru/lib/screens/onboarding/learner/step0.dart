...
import '../../../widgets/mascot/student_sprite.dart';

class LearnerStep0Body extends StatefulWidget {
  const LearnerStep0Body({super.key, required this.onNext});
  final VoidCallback onNext;

  @override
  State<LearnerStep0Body> createState() => _LearnerStep0BodyState();
}

class _LearnerStep0BodyState extends State<LearnerStep0Body>
  ...
  static const _pages = [
    _Page(emoji: '👋', title: "Hi, I'm Hoot!", body: "I'll be your learning buddy on HomeGuru. Let me show you around!", color: Color(0xFFD3E3FD), onColor: Color(0xFF041E49)),
    _Page(emoji: '📚', title: 'Learn anything', body: 'From academics to music, coding to cooking — thousands of expert tutors are here for you.', color: Color(0xFFFFDCC2), onColor: Color(0xFF3A1500)),
    _Page(emoji: '⚡', title: 'Book in seconds', body: "Pick a tutor, choose a time that works for you, and you're all set. No hassle.", color: Color(0xFFDCEEFB), onColor: Color(0xFF0D2137)),
    _Page(emoji: '🏆', title: 'Track your progress', body: 'Earn badges, hit streaks and watch yourself grow with every session.', color: Color(0xFFD3E3FD), onColor: Color(0xFF041E49)),
    _Page(emoji: '🚀', title: "Let's get started!", body: 'Create your free account in under 2 minutes and start learning today.', color: Color(0xFFFFDCC2), onColor: Color(0xFF3A1500)),
  ];
        ...
        children: [
          ...
          Expanded(
            ...
            child: AnimatedBuilder(
              ...
              child: Center(
                child: StudentSprite(size: size.width >= 600 ? 220 : size.height < 700 ? 150 : 190),
              ),
            ),
          ),
          // Bubble
          ...
          Padding(
            ...
            child: FilledButton(onPressed: _advance, child: Text(isLast ? "Let's go!" : 'Next')),
          ),
        ],
      ),
    );
