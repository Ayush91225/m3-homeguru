...
class TutorTodaySchedule extends StatefulWidget {
  ...
  @override
  State<TutorTodaySchedule> createState() => _TutorTodayScheduleState();
}

class _TutorTodayScheduleState extends State<TutorTodaySchedule> {
  int _currentIndex = 0;
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: session['isPaid'] == true ? cs.tertiary : cs.surfaceContainerHighest,
                            borderRadius: BorderRadius.circular(999),
                          ),
                          child: Text(
                            session['isPaid'] == true ? 'Paid' : 'Demo',
                            style: tt.labelSmall?.copyWith(
                              color: session['isPaid'] == true ? cs.onTertiary : cs.onSurfaceVariant,
                              fontWeight: FontWeight.w600,
                              fontSize: 9,
                            ),
                          ),
            ...
            children: [
              FilledButton(
                    ...
                    MaterialPageRoute(
                      builder: (_) => PrejoinScreen(
                        ...
                        event: CalendarEvent(
                          ...
                          tone: EventTone.amber,
                          type: 'class',
                          teacher: widget.session['learner'],
                        ...
                        tutor: ChatTutor(
                          id: widget.session['learner'],
                          name: widget.session['learner'],
                          subject: widget.session['subject'],
                ...
                style: FilledButton.styleFrom(
                  backgroundColor: widget.cs.tertiaryContainer,
                  foregroundColor: widget.cs.onTertiaryContainer,
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 13,
                    fontWeight: FontWeight.w500,
                    color: widget.isActive ? widget.cs.onTertiaryContainer : widget.cs.onSurfaceVariant,
                  ),
                ),
              ),
              Container(
                width: 1,
                height: 36,
                color: widget.cs.onTertiaryContainer.withValues(alpha: 0.2),
              ),
              InkWell(
                onTap: () {
